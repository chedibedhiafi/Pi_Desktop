...
public class MainFXMLController implements Initializable {
    ...
    private Produit getDataFromScene(Parent scene){
        ...
        System.out.println(idLBL.getText());
             sp.modifierProduit(new Produit(Integer.parseInt(idLBL.getText()),sc.retrivecatégorie(Integer.parseInt(categorieTXT.getText())),nomTXT.getText(),Integer.parseInt(prixTXT.getText()),Integer.parseInt(promotionTXT.getText())));
    ...
    @FXML
    private void SwitchToPromotion(ActionEvent event) throws IOException {
         root = FXMLLoader.load(getClass().getResource("mainPromotion.fxml"));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
