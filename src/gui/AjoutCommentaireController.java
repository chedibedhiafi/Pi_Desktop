...
public class AjoutCommentaireController implements Initializable {
    ...
    private void ajoutComment(ActionEvent event) throws IOException {
        ...
        Commentaire c = new Commentaire(CommentContenuTF.getText(),java.sql.Date.valueOf(LocalDate.now()), sb.RetrieveBlog(Integer.parseInt(this.idBlog.getText())), su.retrieveUtilisateur(5));
