...
public class CommentaireController implements Initializable {
    ...
    private void upvote_onClick(ActionEvent event) {
        sv.ajouterVote(new Vote (1, sc.RetrieveCommentaires(Integer.parseInt(idComment.getText())), su.retrieveUtilisateur(u.getId())));
    }
    ...
    private void updateComment_onClick(ActionEvent event) throws IOException {
        ...
        modifierblogcontroller.idComment(idCommentaire, idBlog.getText());
