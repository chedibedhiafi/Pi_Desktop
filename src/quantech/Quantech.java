...
//
//        // MODIFIER LIVRAISON 
// Livraison l= new Livraison(11,50f,1,24555445,sc.retrieveCommande(10));
//       System.out.println("Update\n");
...
// System.out.println(sp.filtrageproduit(900, 1000));
// 
//triASC
...
//       //sr1.ajouter (new Rate( 15 ,1, 44.0));
//      boolean Ok ;
      //Ok = sr1.isRated(12, 15 );
      //afficher
